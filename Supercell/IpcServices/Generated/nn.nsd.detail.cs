...
namespace Supercell.IpcServices.Nn.Nsd.Detail {
	...
	public unsafe class _Base_IManager : IpcInterface {
		...
		public virtual void DeleteSettings(uint _0) => "Stub hit for Nn.Nsd.Detail.IManager.DeleteSettings [13]".Debug();
		...
		public virtual void WriteSaveDataToFsForTest(Buffer<byte> _0) => "Stub hit for Nn.Nsd.Detail.IManager.WriteSaveDataToFsForTest [61]".Debug();
		public virtual void DeleteSaveDataOfFsForTest() => "Stub hit for Nn.Nsd.Detail.IManager.DeleteSaveDataOfFsForTest [62]".Debug();
	}
}
