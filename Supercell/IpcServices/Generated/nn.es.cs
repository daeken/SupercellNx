...
namespace Supercell.IpcServices.Nn.Es {
	...
	public unsafe class _Base_IETicketService : IpcInterface {
		...
		public virtual void ImportTicket(Buffer<byte> _0, Buffer<byte> _1) => "Stub hit for Nn.Es.IETicketService.ImportTicket [1]".Debug();
		public virtual void ImportTicketCertificateSet(Buffer<byte> _0) => "Stub hit for Nn.Es.IETicketService.ImportTicketCertificateSet [2]".Debug();
		public virtual void DeleteTicket(Buffer<byte> _0) => "Stub hit for Nn.Es.IETicketService.DeleteTicket [3]".Debug();
		public virtual void DeletePersonalizedTicket(object _0) => "Stub hit for Nn.Es.IETicketService.DeletePersonalizedTicket [4]".Debug();
		public virtual void DeleteAllCommonTicket() => "Stub hit for Nn.Es.IETicketService.DeleteAllCommonTicket [5]".Debug();
		public virtual void DeleteAllPersonalizedTicket() => "Stub hit for Nn.Es.IETicketService.DeleteAllPersonalizedTicket [6]".Debug();
		public virtual void DeleteAllPersonalizedTicketEx(Buffer<byte> _0) => "Stub hit for Nn.Es.IETicketService.DeleteAllPersonalizedTicketEx [7]".Debug();
		...
		public virtual void ImportPrepurchaseRecord(Buffer<byte> _0) => "Stub hit for Nn.Es.IETicketService.ImportPrepurchaseRecord [24]".Debug();
		public virtual void DeletePrepurchaseRecord(Buffer<byte> _0) => "Stub hit for Nn.Es.IETicketService.DeletePrepurchaseRecord [25]".Debug();
		public virtual void DeleteAllPrepurchaseRecord() => "Stub hit for Nn.Es.IETicketService.DeleteAllPrepurchaseRecord [26]".Debug();
