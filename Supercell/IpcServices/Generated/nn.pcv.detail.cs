...
namespace Supercell.IpcServices.Nn.Pcv.Detail {
	...
	public unsafe class _Base_IPcvService : IpcInterface {
		...
		public virtual void SetPowerEnabled(byte _0, uint _1) => "Stub hit for Nn.Pcv.Detail.IPcvService.SetPowerEnabled [0]".Debug();
		public virtual void SetClockEnabled(byte _0, uint _1) => "Stub hit for Nn.Pcv.Detail.IPcvService.SetClockEnabled [1]".Debug();
		public virtual void SetClockRate(uint _0, uint _1) => "Stub hit for Nn.Pcv.Detail.IPcvService.SetClockRate [2]".Debug();
		...
		public virtual void SetMinVClockRate(uint _0, uint _1) => "Stub hit for Nn.Pcv.Detail.IPcvService.SetMinVClockRate [6]".Debug();
		public virtual void SetReset(byte _0, uint _1) => "Stub hit for Nn.Pcv.Detail.IPcvService.SetReset [7]".Debug();
		public virtual void SetVoltageEnabled(byte _0, uint _1) => "Stub hit for Nn.Pcv.Detail.IPcvService.SetVoltageEnabled [8]".Debug();
		...
		public virtual void SetVoltageValue(uint _0, uint _1) => "Stub hit for Nn.Pcv.Detail.IPcvService.SetVoltageValue [11]".Debug();
		...
		public virtual void SetTemperature(uint _0) => "Stub hit for Nn.Pcv.Detail.IPcvService.SetTemperature [14]".Debug();
		public virtual void Initialize() => "Stub hit for Nn.Pcv.Detail.IPcvService.Initialize [15]".Debug();
		public virtual byte IsInitialized() => throw new NotImplementedException();
		public virtual void Finalize() => "Stub hit for Nn.Pcv.Detail.IPcvService.Finalize [17]".Debug();
		public virtual void PowerOn(uint _0, uint _1) => "Stub hit for Nn.Pcv.Detail.IPcvService.PowerOn [18]".Debug();
		public virtual void PowerOff(uint _0) => "Stub hit for Nn.Pcv.Detail.IPcvService.PowerOff [19]".Debug();
		public virtual void ChangeVoltage(uint _0, uint _1) => "Stub hit for Nn.Pcv.Detail.IPcvService.ChangeVoltage [20]".Debug();
