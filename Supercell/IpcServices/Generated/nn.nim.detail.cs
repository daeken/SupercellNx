...
namespace Supercell.IpcServices.Nn.Nim.Detail {
	...
	public unsafe class _Base_INetworkInstallManager : IpcInterface {
		...
		public virtual void DestroySystemUpdateTask(object _0) => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.DestroySystemUpdateTask [1]".Debug();
		...
		public virtual void CommitSystemUpdateTask(object _0) => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.CommitSystemUpdateTask [5]".Debug();
		public virtual object CreateNetworkInstallTask(object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void DestroyNetworkInstallTask(object _0) => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.DestroyNetworkInstallTask [7]".Debug();
		...
		public virtual void CommitNetworkInstallTask(object _0) => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.CommitNetworkInstallTask [11]".Debug();
		...
		public virtual void SetNetworkInstallTaskAttribute(object _0) => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.SetNetworkInstallTaskAttribute [17]".Debug();
		public virtual void AddNetworkInstallTaskContentMeta(object _0, Buffer<byte> _1) => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.AddNetworkInstallTaskContentMeta [18]".Debug();
		...
		public virtual void DestroyApplyDeltaTask(object _0) => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.DestroyApplyDeltaTask [32]".Debug();
		...
		public virtual void CommitApplyDeltaTask(object _0) => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.CommitApplyDeltaTask [37]".Debug();
		public virtual object CalculateApplyDeltaTaskRequiredSize(object _0) => throw new NotImplementedException();
		public virtual void PrepareShutdown() => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.PrepareShutdown [39]".Debug();
		public virtual void ListApplyDeltaTask2(out object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void ClearNotEnoughSpaceStateOfApplyDeltaTask(object _0) => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.ClearNotEnoughSpaceStateOfApplyDeltaTask [41]".Debug();
		...
		public virtual void Unknown46() => "Stub hit for Nn.Nim.Detail.INetworkInstallManager.Unknown46 [46]".Debug();
	}
	...
	public unsafe class _Base_IAsyncData : IpcInterface {
		...
		public virtual void Unknown0() => "Stub hit for Nn.Nim.Detail.IAsyncData.Unknown0 [0]".Debug();
		public virtual void Unknown1() => "Stub hit for Nn.Nim.Detail.IAsyncData.Unknown1 [1]".Debug();
	...
	public unsafe class _Base_IAsyncProgressResult : IpcInterface {
		...
		public virtual void Unknown0() => "Stub hit for Nn.Nim.Detail.IAsyncProgressResult.Unknown0 [0]".Debug();
		public virtual void Unknown1() => "Stub hit for Nn.Nim.Detail.IAsyncProgressResult.Unknown1 [1]".Debug();
		public virtual object Unknown2() => throw new NotImplementedException();
	...
	public unsafe class _Base_IAsyncResult : IpcInterface {
		...
		public virtual void Unknown0() => "Stub hit for Nn.Nim.Detail.IAsyncResult.Unknown0 [0]".Debug();
		public virtual void Unknown1() => "Stub hit for Nn.Nim.Detail.IAsyncResult.Unknown1 [1]".Debug();
	...
	public unsafe class _Base_IAsyncValue : IpcInterface {
		...
		public virtual void Unknown2() => "Stub hit for Nn.Nim.Detail.IAsyncValue.Unknown2 [2]".Debug();
		public virtual void Unknown3(Buffer<byte> _0) => throw new NotImplementedException();
	}
}
