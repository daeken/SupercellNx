...
namespace Supercell.IpcServices.Nn.Settings {
	...
	public unsafe class _Base_IFactorySettingsServer : IpcInterface {
		public void Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 10: { // SetInitialSystemAppletProgramId
					SetInitialSystemAppletProgramId(im.GetData<ulong>(0));
					break;
				}
				case 11: { // SetOverlayDispProgramId
					SetOverlayDispProgramId(im.GetData<ulong>(0));
					break;
				}
		...
		public virtual void SetInitialSystemAppletProgramId(ulong _0) => throw new NotImplementedException();
		public virtual void SetOverlayDispProgramId(ulong _0) => throw new NotImplementedException();
	...
	public unsafe class _Base_IFirmwareDebugSettingsServer : IpcInterface {
		public void Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 10: { // ReadSettings
					ReadSettings(im.GetData<uint>(0), out var _0, im.GetBuffer<byte>(0x6, 0));
					om.SetData(0, _0);
					break;
				}
				case 11: { // ResetSettings
					ResetSettings(im.GetData<uint>(0));
					break;
				}
				case 20: { // SetWebInspectorFlag
					SetWebInspectorFlag(im.GetData<byte>(0));
					break;
				}
		...
		public virtual void SetSettingsItemValue(Buffer<byte> _0, Buffer<byte> _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void ResetSettingsItemValue(Buffer<byte> _0, Buffer<byte> _1) => throw new NotImplementedException();
		...
		public virtual void ResetSettings(uint _0) => throw new NotImplementedException();
		public virtual void SetWebInspectorFlag(byte _0) => throw new NotImplementedException();
		public virtual void SetAllowedSslHosts(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual void SetHostFsMountPoint(Buffer<byte> _0) => throw new NotImplementedException();
	}
		...
		public void Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 2: { // MakeLanguageCode
					MakeLanguageCode(im.GetData<uint>(0), out var _0);
					om.SetBytes(0, _0);
					break;
				}
	...
	public unsafe class _Base_ISystemSettingsServer : IpcInterface {
		public void Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // SetLanguageCode
					SetLanguageCode(im.GetBytes(0, 0x8));
					break;
				}
				...
				case 8: { // SetLockScreenFlag
					SetLockScreenFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 10: { // SetBacklightSettings
					SetBacklightSettings(im.GetBytes(0, 0x28));
					break;
				}
				...
				case 14: { // SetExternalSteadyClockSourceId
					SetExternalSteadyClockSourceId(im.GetBytes(0, 0x10));
					break;
				}
				...
				case 16: { // SetUserSystemClockContext
					SetUserSystemClockContext(im.GetBytes(0, 0x20));
					break;
				}
				...
				case 18: { // SetAccountSettings
					SetAccountSettings(im.GetData<uint>(0));
					break;
				}
				case 19: { // GetAudioVolume
					GetAudioVolume(im.GetData<uint>(0), out var _0);
					om.SetBytes(0, _0);
					break;
				}
				case 20: { // SetAudioVolume
					SetAudioVolume(im.GetBytes(0, 0x8), im.GetData<uint>(8));
					break;
				}
				...
				case 24: { // SetColorSetId
					SetColorSetId(im.GetData<uint>(0));
					break;
				}
				...
				case 26: { // SetConsoleInformationUploadFlag
					SetConsoleInformationUploadFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 28: { // SetAutomaticApplicationDownloadFlag
					SetAutomaticApplicationDownloadFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 30: { // SetNotificationSettings
					SetNotificationSettings(im.GetBytes(0, 0x18));
					break;
				}
				...
				case 40: { // SetTvSettings
					SetTvSettings(im.GetBytes(0, 0x20));
					break;
				}
				case 41: { // GetEdid
				...
				case 46: { // SetForceMuteOnHeadphoneRemoved
					SetForceMuteOnHeadphoneRemoved(im.GetData<byte>(0));
					break;
				}
				...
				case 48: { // SetQuestFlag
					SetQuestFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 50: { // SetDataDeletionSettings
					SetDataDeletionSettings(im.GetBytes(0, 0x8));
					break;
				}
				...
				case 54: { // SetDeviceTimeZoneLocationName
					SetDeviceTimeZoneLocationName(im.GetBytes(0, 0x24));
					break;
				}
				...
				case 57: { // SetRegionCode
					SetRegionCode(im.GetData<uint>(0));
					break;
				}
				...
				case 59: { // SetNetworkSystemClockContext
					SetNetworkSystemClockContext(im.GetBytes(0, 0x20));
					break;
				}
				...
				case 61: { // SetUserSystemClockAutomaticCorrectionEnabled
					SetUserSystemClockAutomaticCorrectionEnabled(im.GetData<byte>(0));
					break;
				}
				...
				case 64: { // SetPrimaryAlbumStorage
					SetPrimaryAlbumStorage(im.GetData<uint>(0));
					break;
				}
				...
				case 66: { // SetUsb30EnableFlag
					SetUsb30EnableFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 70: { // SetNfcEnableFlag
					SetNfcEnableFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 72: { // SetSleepSettings
					SetSleepSettings(im.GetBytes(0, 0xC));
					break;
				}
				...
				case 74: { // SetWirelessLanEnableFlag
					SetWirelessLanEnableFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 76: { // SetInitialLaunchSettings
					SetInitialLaunchSettings(im.GetBytes(0, 0x20));
					break;
				}
				...
				case 81: { // SetLdnChannel
					SetLdnChannel(im.GetData<uint>(0));
					break;
				}
				...
				case 85: { // SetPtmBatteryLot
					SetPtmBatteryLot(im.GetBytes(0, 0x18));
					break;
				}
				...
				case 87: { // SetPtmFuelGaugeParameter
					SetPtmFuelGaugeParameter(im.GetBytes(0, 0x18));
					break;
				}
				...
				case 89: { // SetBluetoothEnableFlag
					SetBluetoothEnableFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 91: { // SetShutdownRtcValue
					SetShutdownRtcValue(im.GetData<ulong>(0));
					break;
				}
				...
				case 96: { // SetAutoUpdateEnableFlag
					SetAutoUpdateEnableFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 100: { // SetBatteryPercentageFlag
					SetBatteryPercentageFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 102: { // SetExternalRtcResetFlag
					SetExternalRtcResetFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 104: { // SetUsbFullKeyEnableFlag
					SetUsbFullKeyEnableFlag(im.GetData<byte>(0));
					break;
				}
				case 105: { // SetExternalSteadyClockInternalOffset
					SetExternalSteadyClockInternalOffset(im.GetData<ulong>(0));
					break;
				}
				...
				case 108: { // SetBacklightSettingsEx
					SetBacklightSettingsEx(im.GetBytes(0, 0x2C));
					break;
				}
				...
				case 110: { // SetHeadphoneVolumeWarningCount
					SetHeadphoneVolumeWarningCount(im.GetData<uint>(0));
					break;
				}
				...
				case 112: { // SetBluetoothAfhEnableFlag
					SetBluetoothAfhEnableFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 114: { // SetBluetoothBoostEnableFlag
					SetBluetoothBoostEnableFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 116: { // SetInRepairProcessEnableFlag
					SetInRepairProcessEnableFlag(im.GetData<byte>(0));
					break;
				}
				...
				case 118: { // SetHeadphoneVolumeUpdateFlag
					SetHeadphoneVolumeUpdateFlag(im.GetData<byte>(0));
					break;
				}
				case 119: { // NeedsToUpdateHeadphoneVolume
					NeedsToUpdateHeadphoneVolume(im.GetData<byte>(0), out var _0, out var _1, out var _2);
					om.SetData(0, _0);
					om.SetData(1, _1);
					om.SetData(2, _2);
					break;
				...
				case 121: { // SetPushNotificationActivityModeOnSleep
					SetPushNotificationActivityModeOnSleep(im.GetData<uint>(0));
					break;
				}
				...
				case 123: { // SetServiceDiscoveryControlSettings
					SetServiceDiscoveryControlSettings(im.GetData<uint>(0));
					break;
				}
				...
				case 125: { // SetErrorReportSharePermission
					SetErrorReportSharePermission(im.GetData<uint>(0));
					break;
				}
				...
				case 129: { // SetConsoleSixAxisSensorAccelerationBias
					SetConsoleSixAxisSensorAccelerationBias(im.GetBytes(0, 0xC));
					break;
				}
				...
				case 131: { // SetConsoleSixAxisSensorAngularVelocityBias
					SetConsoleSixAxisSensorAngularVelocityBias(im.GetBytes(0, 0xC));
					break;
				}
				...
				case 133: { // SetConsoleSixAxisSensorAccelerationGain
					SetConsoleSixAxisSensorAccelerationGain(im.GetBytes(0, 0x24));
					break;
				}
				...
				case 135: { // SetConsoleSixAxisSensorAngularVelocityGain
					SetConsoleSixAxisSensorAngularVelocityGain(im.GetBytes(0, 0x24));
					break;
				}
				...
				case 137: { // SetKeyboardLayout
					SetKeyboardLayout(im.GetData<uint>(0));
					break;
				}
		...
		public virtual void SetLanguageCode(byte[] _0) => throw new NotImplementedException();
		public virtual void SetNetworkSettings(Buffer<byte> _0) => throw new NotImplementedException();
		...
		public virtual void SetLockScreenFlag(byte _0) => throw new NotImplementedException();
		public virtual void GetBacklightSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetBacklightSettings(byte[] _0) => throw new NotImplementedException();
		public virtual void SetBluetoothDevicesSettings(Buffer<byte> _0) => throw new NotImplementedException();
		...
		public virtual void SetExternalSteadyClockSourceId(byte[] _0) => throw new NotImplementedException();
		public virtual void GetUserSystemClockContext(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetUserSystemClockContext(byte[] _0) => throw new NotImplementedException();
		public virtual uint GetAccountSettings() => throw new NotImplementedException();
		public virtual void SetAccountSettings(uint _0) => throw new NotImplementedException();
		public virtual void GetAudioVolume(uint _0, out byte[] _1) => throw new NotImplementedException();
		public virtual void SetAudioVolume(byte[] _0, uint _1) => throw new NotImplementedException();
		public virtual void GetEulaVersions(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void SetEulaVersions(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual uint GetColorSetId() => throw new NotImplementedException();
		public virtual void SetColorSetId(uint _0) => throw new NotImplementedException();
		public virtual byte GetConsoleInformationUploadFlag() => throw new NotImplementedException();
		public virtual void SetConsoleInformationUploadFlag(byte _0) => throw new NotImplementedException();
		public virtual byte GetAutomaticApplicationDownloadFlag() => throw new NotImplementedException();
		public virtual void SetAutomaticApplicationDownloadFlag(byte _0) => throw new NotImplementedException();
		public virtual void GetNotificationSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetNotificationSettings(byte[] _0) => throw new NotImplementedException();
		public virtual void GetAccountNotificationSettings(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void SetAccountNotificationSettings(Buffer<byte> _0) => throw new NotImplementedException();
		...
		public virtual void SetTvSettings(byte[] _0) => throw new NotImplementedException();
		public virtual void GetEdid(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual void SetEdid(Buffer<byte> _0) => throw new NotImplementedException();
		...
		public virtual void SetForceMuteOnHeadphoneRemoved(byte _0) => throw new NotImplementedException();
		public virtual byte GetQuestFlag() => throw new NotImplementedException();
		public virtual void SetQuestFlag(byte _0) => throw new NotImplementedException();
		public virtual void GetDataDeletionSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetDataDeletionSettings(byte[] _0) => throw new NotImplementedException();
		...
		public virtual void SetDeviceTimeZoneLocationName(byte[] _0) => throw new NotImplementedException();
		...
		public virtual void SetRegionCode(uint _0) => throw new NotImplementedException();
		public virtual void GetNetworkSystemClockContext(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetNetworkSystemClockContext(byte[] _0) => throw new NotImplementedException();
		public virtual byte IsUserSystemClockAutomaticCorrectionEnabled() => throw new NotImplementedException();
		public virtual void SetUserSystemClockAutomaticCorrectionEnabled(byte _0) => throw new NotImplementedException();
		...
		public virtual void SetPrimaryAlbumStorage(uint _0) => throw new NotImplementedException();
		public virtual byte GetUsb30EnableFlag() => throw new NotImplementedException();
		public virtual void SetUsb30EnableFlag(byte _0) => throw new NotImplementedException();
		public virtual void GetBatteryLot(out byte[] _0) => throw new NotImplementedException();
		public virtual void GetSerialNumber(out byte[] _0) => throw new NotImplementedException();
		public virtual byte GetNfcEnableFlag() => throw new NotImplementedException();
		public virtual void SetNfcEnableFlag(byte _0) => throw new NotImplementedException();
		public virtual void GetSleepSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetSleepSettings(byte[] _0) => throw new NotImplementedException();
		public virtual byte GetWirelessLanEnableFlag() => throw new NotImplementedException();
		public virtual void SetWirelessLanEnableFlag(byte _0) => throw new NotImplementedException();
		public virtual void GetInitialLaunchSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetInitialLaunchSettings(byte[] _0) => throw new NotImplementedException();
		public virtual void GetDeviceNickName(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual void SetDeviceNickName(Buffer<byte> _0) => throw new NotImplementedException();
		...
		public virtual void SetLdnChannel(uint _0) => throw new NotImplementedException();
		...
		public virtual void SetPtmBatteryLot(byte[] _0) => throw new NotImplementedException();
		public virtual void GetPtmFuelGaugeParameter(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetPtmFuelGaugeParameter(byte[] _0) => throw new NotImplementedException();
		public virtual byte GetBluetoothEnableFlag() => throw new NotImplementedException();
		public virtual void SetBluetoothEnableFlag(byte _0) => throw new NotImplementedException();
		public virtual void GetMiiAuthorId(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetShutdownRtcValue(ulong _0) => throw new NotImplementedException();
		...
		public virtual void SetAutoUpdateEnableFlag(byte _0) => throw new NotImplementedException();
		public virtual void GetNxControllerSettings(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void SetNxControllerSettings(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual byte GetBatteryPercentageFlag() => throw new NotImplementedException();
		public virtual void SetBatteryPercentageFlag(byte _0) => throw new NotImplementedException();
		public virtual byte GetExternalRtcResetFlag() => throw new NotImplementedException();
		public virtual void SetExternalRtcResetFlag(byte _0) => throw new NotImplementedException();
		public virtual byte GetUsbFullKeyEnableFlag() => throw new NotImplementedException();
		public virtual void SetUsbFullKeyEnableFlag(byte _0) => throw new NotImplementedException();
		public virtual void SetExternalSteadyClockInternalOffset(ulong _0) => throw new NotImplementedException();
		...
		public virtual void SetBacklightSettingsEx(byte[] _0) => throw new NotImplementedException();
		public virtual uint GetHeadphoneVolumeWarningCount() => throw new NotImplementedException();
		public virtual void SetHeadphoneVolumeWarningCount(uint _0) => throw new NotImplementedException();
		public virtual byte GetBluetoothAfhEnableFlag() => throw new NotImplementedException();
		public virtual void SetBluetoothAfhEnableFlag(byte _0) => throw new NotImplementedException();
		public virtual byte GetBluetoothBoostEnableFlag() => throw new NotImplementedException();
		public virtual void SetBluetoothBoostEnableFlag(byte _0) => throw new NotImplementedException();
		public virtual byte GetInRepairProcessEnableFlag() => throw new NotImplementedException();
		public virtual void SetInRepairProcessEnableFlag(byte _0) => throw new NotImplementedException();
		public virtual byte GetHeadphoneVolumeUpdateFlag() => throw new NotImplementedException();
		public virtual void SetHeadphoneVolumeUpdateFlag(byte _0) => throw new NotImplementedException();
		...
		public virtual void SetPushNotificationActivityModeOnSleep(uint _0) => throw new NotImplementedException();
		public virtual uint GetServiceDiscoveryControlSettings() => throw new NotImplementedException();
		public virtual void SetServiceDiscoveryControlSettings(uint _0) => throw new NotImplementedException();
		public virtual uint GetErrorReportSharePermission() => throw new NotImplementedException();
		public virtual void SetErrorReportSharePermission(uint _0) => throw new NotImplementedException();
		public virtual object GetAppletLaunchFlags() => throw new NotImplementedException();
		public virtual void SetAppletLaunchFlags(object _0) => throw new NotImplementedException();
		public virtual void GetConsoleSixAxisSensorAccelerationBias(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetConsoleSixAxisSensorAccelerationBias(byte[] _0) => throw new NotImplementedException();
		public virtual void GetConsoleSixAxisSensorAngularVelocityBias(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetConsoleSixAxisSensorAngularVelocityBias(byte[] _0) => throw new NotImplementedException();
		public virtual void GetConsoleSixAxisSensorAccelerationGain(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetConsoleSixAxisSensorAccelerationGain(byte[] _0) => throw new NotImplementedException();
		public virtual void GetConsoleSixAxisSensorAngularVelocityGain(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetConsoleSixAxisSensorAngularVelocityGain(byte[] _0) => throw new NotImplementedException();
		public virtual uint GetKeyboardLayout() => throw new NotImplementedException();
		public virtual void SetKeyboardLayout(uint _0) => throw new NotImplementedException();
	...
	public unsafe class _Base_ISettingsItemKeyIterator : IpcInterface {
		...
		public virtual void GoNext() => throw new NotImplementedException();
