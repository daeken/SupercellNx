...
namespace Supercell.IpcServices.Nn.Tma {
	...
	public unsafe class _Base_IHtcManager : IpcInterface {
		...
		public virtual void SetUsbDetachedForDebug(byte _0) => "Stub hit for Nn.Tma.IHtcManager.SetUsbDetachedForDebug [8]".Debug();
	...
	public unsafe class _Base_IHtcsManager : IpcInterface {
		...
		public virtual void RegisterProcessId(ulong _0, ulong _1) => "Stub hit for Nn.Tma.IHtcsManager.RegisterProcessId [100]".Debug();
		public virtual void MonitorManager(ulong _0, ulong _1) => "Stub hit for Nn.Tma.IHtcsManager.MonitorManager [101]".Debug();
	}
