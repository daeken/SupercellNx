...
namespace Supercell.IpcServices.Nn.Codec.Detail {
	...
	public unsafe class _Base_IHardwareOpusDecoder : IpcInterface {
		...
		public virtual void SetContext(Buffer<byte> _0) => "Stub hit for Nn.Codec.Detail.IHardwareOpusDecoder.SetContext [1]".Debug();
		public virtual void Unknown2(Buffer<byte> _0, out uint _1, out uint _2, Buffer<byte> _3) => throw new NotImplementedException();
		public virtual void Unknown3(Buffer<byte> _0) => "Stub hit for Nn.Codec.Detail.IHardwareOpusDecoder.Unknown3 [3]".Debug();
