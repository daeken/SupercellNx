		...
		public unsafe bool Interpret(uint inst, ulong pc) {
			unchecked {
				...
				if((inst & 0xFFE0FC00U) == 0x5E000400U) {
					...
					switch(size) {
						case 0x8: {
							(&State->V0)[(int) (rd)] = new Vector128<byte>().WithElement(0, (byte) (((Vector128<float>) ((&State->V0)[rn])).Element<byte>(index))).As<byte, float>();
							break;
						}
						case 0x10: {
							(&State->V0)[(int) (rd)] = new Vector128<ushort>().WithElement(0, (ushort) (((Vector128<float>) ((&State->V0)[rn])).Element<ushort>(index))).As<ushort, float>();
							break;
						}
						case 0x20: {
							(&State->V0)[(int) (rd)] = new Vector128<float>().WithElement(0, (float) (((Vector128<float>) ((&State->V0)[rn])).Element<float>(index)));
							break;
						}
						case 0x40: {
							(&State->V0)[(int) (rd)] = new Vector128<double>().WithElement(0, (double) (((Vector128<float>) ((&State->V0)[rn])).Element<double>(index))).As<double, float>();
							break;
						}
						default: {
							throw new NotImplementedException();
				...
				if((inst & 0xBF80F400U) == 0x0F801000U) {
					...
					if((sz) != 0) {
						(&State->V0)[rd] = (Vector128<float>) (Sse2.Add(((Vector128<float>) ((&State->V0)[rd])).As<float, double>(), ((Vector128<float>) (Sse2.Multiply(((Vector128<float>) ((&State->V0)[rn])).As<float, double>(), ((Vector128<float>) (Vector128.Create((double) (((Vector128<float>) ((&State->V0)[rm])).Element<double>(index))).As<double, float>())).As<float, double>()).As<double, float>())).As<float, double>()).As<double, float>());
					} else {
						(&State->V0)[rd] = (Vector128<float>) (Sse.Add((Vector128<float>) ((&State->V0)[rd]), (Vector128<float>) (Sse.Multiply((Vector128<float>) ((&State->V0)[rn]), (Vector128<float>) (Vector128.Create((float) (((Vector128<float>) ((&State->V0)[rm])).Element<float>(index))).As<float, float>())))));
					}
					return true;
				}
				/* FMLA-vector */
				if((inst & 0xBFA0FC00U) == 0x0E20CC00U) {
					...
					if((sz) != 0) {
						(&State->V0)[rd] = (Vector128<float>) (Sse2.Add(((Vector128<float>) ((&State->V0)[rd])).As<float, double>(), ((Vector128<float>) (Sse2.Multiply(((Vector128<float>) ((&State->V0)[rn])).As<float, double>(), ((Vector128<float>) ((&State->V0)[rm])).As<float, double>()).As<double, float>())).As<float, double>()).As<double, float>());
					} else {
						(&State->V0)[rd] = (Vector128<float>) (Sse.Add((Vector128<float>) ((&State->V0)[rd]), (Vector128<float>) (Sse.Multiply((Vector128<float>) ((&State->V0)[rn]), (Vector128<float>) ((&State->V0)[rm])))));
					}
					return true;
				}
				/* FMOV-general */
				...
				if((inst & 0xBF80F400U) == 0x0F809000U) {
					...
					var index = (uint) (((byte) ((byte) (((byte) (((byte) (L)) << 0)) | ((byte) (((byte) (sz)) << 1))))) switch { 0x2 => (uint) ((uint) (H)), 0x3 => throw new NotImplementedException(), _ => (uint) ((uint) ((byte) ((byte) (((byte) (((byte) (L)) << 0)) | ((byte) (((byte) (H)) << 1)))))) });
					if((sz) != 0) {
						(&State->V0)[rd] = (Vector128<float>) (Sse2.Multiply(((Vector128<float>) ((&State->V0)[rn])).As<float, double>(), ((Vector128<float>) (Vector128.Create((double) (((Vector128<float>) ((&State->V0)[rm])).Element<double>(index))).As<double, float>())).As<float, double>()).As<double, float>());
					} else {
						(&State->V0)[rd] = (Vector128<float>) (Sse.Multiply((Vector128<float>) ((&State->V0)[rn]), (Vector128<float>) (Vector128.Create((float) (((Vector128<float>) ((&State->V0)[rm])).Element<float>(index))).As<float, float>())));
					}
					return true;
				}
				/* FMUL-scalar */
